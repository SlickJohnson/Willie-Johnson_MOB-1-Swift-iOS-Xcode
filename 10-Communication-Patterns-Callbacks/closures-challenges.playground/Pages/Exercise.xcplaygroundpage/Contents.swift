 ...
 */
func doesApply(a: Int, b: Int, fn: (Int, Int) -> Bool) -> Bool {
    return fn(a,b)
}
...
doesApply(a: 47685, b: 344832, fn: areBothDivisibleByThree)

doesApply(a: 85436, b: 53893) {
    $0 % 3 == 0 && $1 % 3 == 0
}

doesApply(a: 123, b: 1113) {
    sumOfDigits(a: $0) == sumOfDigits(a: $1)
}

func manipulateStrings(a: String, b: String, fn: (String, String) -> String?) -> String? {
    return fn(a, b)
}
...
manipulateStrings(a: "abc", b: "def") {
    concatenateSmallStrings(a: $0, b: $1)
}

manipulateStrings(a: "abcdef", b: "ghijkl") {
    concatenateSmallStrings(a: $0, b: $1)
}
